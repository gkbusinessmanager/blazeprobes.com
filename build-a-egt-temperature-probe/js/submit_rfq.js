$(document).ready(function(){
	...
	$("#rfq_submit").click(function(event){
		event.preventDefault();
		var formData = $('#formrfq').serialize();
		...
		if (rfqconf&&rfqcompany&&rfqname&&rfqphone&&rfqemail&&rfqqty){
			$.ajax({type: "POST",url: "https://blazeprobes.com/build-a-egt-temperature-probe/?page=send_rfq_email",
				data: formData,
				success: function(msg){
					if(msg == "sent")
					{
						$("#myModalll").modal("hide");
